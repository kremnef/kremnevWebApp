...
<date:months>
   <date:month length="31" abbr="Jan">Января</date:month>
   <date:month length="28" abbr="Feb">Февраля</date:month>
   <date:month length="31" abbr="Mar">Марта</date:month>
   <date:month length="30" abbr="Apr">Апреля</date:month>
   <date:month length="31" abbr="May">Мая</date:month>
   <date:month length="30" abbr="Jun">Июня</date:month>
   <date:month length="31" abbr="Jul">Июля</date:month>
   <date:month length="31" abbr="Aug">Августа</date:month>
   <date:month length="30" abbr="Sep">Сентября</date:month>
   <date:month length="31" abbr="Oct">Октября</date:month>
   <date:month length="30" abbr="Nov">Ноября</date:month>
   <date:month length="31" abbr="Dec">Декабря</date:month>
</date:months>

<date:days>
   <date:day abbr="Sun">Воскресенье</date:day>
   <date:day abbr="Mon">Понедельник</date:day>
   <date:day abbr="Tue">Вторник</date:day>
   <date:day abbr="Wed">Среда</date:day>
   <date:day abbr="Thu">Четверг</date:day>
   <date:day abbr="Fri">Пятница</date:day>
   <date:day abbr="Sat">Суббота</date:day>
</date:days>
