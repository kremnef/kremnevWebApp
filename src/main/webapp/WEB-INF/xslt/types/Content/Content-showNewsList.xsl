...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="value[typeAction/name='showNewsList' and typifiedObject/objectType/name='Content']">
    ...
    <ems:templ name="showContents-showNewsList"/>
    <ems:templ name="showContentBriefly-showNewsList"/>

    <xsl:template match="ems:templ[@name='showContents-showNewsList']">
    ...
    <xsl:template match="ems:templ[@name='showContentBriefly-showNewsList']">
        ...
        <div class="news-block">
            ...
            <xsl:choose>
                    ...
                    <xsl:variable name="smallImageName">
                        <xsl:choose>
                            <xsl:when test="$dotLastIndex = 0">
                                <xsl:value-of select="concat($imageName, '-small')"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of
                                        select="concat(substring($imageName, 1, $dotLastIndex - 1), '-small.jpg')"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <div class="image">
                ...
                <xsl:otherwise>
                    <div class="image">
                        <img alt="{$name}" border="0" src="{$servletPath}/img/spacer.gif" width="200px" height="113px"/>
                    </div>
                </xsl:otherwise>
            </xsl:choose>
