        ...
        <xsl:if test="$doc">
            ...
            <div id="{typifiedObject/systemName}" class="{typeAction/name}">
                ...
                <link rel="stylesheet" type="text/css"
                      href="{$servletPath}/css/types/Content/Content-showFeedbackHTML.css"/>
                    ...
                    <div id="form-div">
                        <form action="{$servletPath}/{$sitemapPath}/sendletter" method="post" id="send-letter-form">
                            ...
                            <div id="name-div">
                                ...
                                <input type="text" name="name-input" id="name-input" class="required" minlength="2"/>
                            </div>
                            <div id="email-div">
                                <label for="email-input">Email</label>
                                <input type="text" name="email-input" id="email-input" class="required email"/>
                            </div>
                            <div id="content-div">
                                <label for="content-textarea">Текст письма</label>
                                <textarea name="content-textarea" id="content-textarea" class="required"/>
                            </div>
                            <div id="captcha-div">
                                <label for="captcha-input">Введите текст, изображенный на картинке</label>
                                <img id="captcha-img"
                                     src="{$blockPrefix}/service/captcha?background={$backgroundColor}"/>
                                <input type="text" id="captcha-input" name="captcha-input" class="required"
                                       minlength="5"/>
                            </div>
                            <div id="send-div">
                                <input type="button" class="ui-button ui-state-default ui-corner-all " id="send-input"
                                       name="send-input" value="Отправить письмо"/>
                            </div>
                        </form>
                    </div>
                </div>
