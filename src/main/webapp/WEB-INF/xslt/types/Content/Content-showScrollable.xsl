...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="value[typeAction/name='showScrollable' and typifiedObject/objectType/name='Content']">
        ...
        <div class="widget-{$position}">
            ...
            <div id="{$systemName}-{$position}" class="showScrollable">
                ...
                <xsl:if test="$objectURL != ''">
                    <xsl:variable name="child" select="/root/childrenMap/children/entry[key/parentId=$parentId and key/systemName=$systemName]/value/item[emsObject/systemName = $objectURL]"/>
                    <xsl:if test="$child">
        ...
        <!--<ems:templ name="showContentBriefly-showScrollable"/>-->
    </xsl:template>

    <!--<xsl:template match="ems:templ[@name='showContentBriefly-showScrollable']">-->
