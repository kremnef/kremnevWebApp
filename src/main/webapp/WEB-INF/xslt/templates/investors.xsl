            ...
            <div class="top">
                <div class="left">
                    <div class="right">
                        ...
                        <div class="center"><img src="{$servletPath}/{$sitemapPath}img/spacer.gif" alt=""/></div>
                    </div>
                </div>
            </div>
            <div class="middle">
                    ...
                    <div class="right">
                        <div class="center">
                            <!--<div class="sub-menu">-->
                                ...
                                <!--<div class="menu-item">-->
                                    <!--<a href="#">Инвестиции</a>-->
                                    <!--<div class="description">инвестиционная программа</div>-->
                                <!--</div>-->
                                <!--<div class="menu-item">-->
                                    <!--<a href="#">Основные показатели</a>-->
                                    <!--<div class="description">Показатели деятельности</div>-->

                                <!--</div>-->
                                <!--<div class="menu-item">-->
                                    <!--<a href="#">Органы управления и контроля</a>-->
                                    <!--<div class="description">Структура компании</div>-->
                                <!--</div>-->
                            <!--</div>-->
                            <xsl:apply-templates select="systemNodeObjects/object/entry[key = 5]/value"/>

                            <div class="info">
                                <!--<div class="contacts"><a href="#">Контакты инвесторам</a></div>-->
                                ...
                                <!--<div class="banner"><img alt="" src="{$servletPath}/img/utilization.png"/></div>-->
                                <div class="banner"><xsl:apply-templates select="systemNodeObjects/object/entry[key = 8]/value"/></div>

                                <!--<div class="open-data">-->

                                    <!--<h1>Раскрытие информации</h1>-->
                                    <!--<ul>-->
                                        <!--<li><a href="#">Эмиссионные документы</a></li>-->
                                        <!--<li><a href="#">Сведения влияющие на стоимость ценных бумаг</a></li>-->
                                        <!--<li><a href="#">Списки аффилированных лиц</a></li>-->
                                        <!--<li><a href="#">Сообщения на этапах процедуры эмиссии ценных бумаг</a></li>-->

                                        <!--<li><a href="#">Сообщения о существенных фактах</a></li>-->
                            ...
                            <div class="print"><!--<a href="#"><i18n:text key="Page.printVersion"/></a>--></div>
                        </div>
                    </div>
                </div>
            </div>
