...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="styles">
        ...
        <!--media="screen"/>-->
        <!--<link rel="stylesheet" type="text/css" media="print" href="{$servletPath}/{$sitemapPath}/css/print.css"/>-->
    </xsl:template>
                ...
                <div class="left">
                    <div class="right">
                        <div class="center">
                            ...
                            <xsl:if test="systemNodeObjects/object/entry[key = 7]/value != null">
                                <div class="extra">
