                ...
                <div class="left">
                    <div class="right">
                        <div class="center">
                            ...
                            <div class="extra">
                                <!--Тарифы-->
                                <xsl:apply-templates select="systemNodeObjects/object/entry[key = 14]/value"/>
                                <xsl:apply-templates select="systemNodeObjects/object/entry[key = 15]/value"/>
                                <xsl:apply-templates select="systemNodeObjects/object/entry[key = 16]/value"/>
